...
#define BIND_EVENT_FN(x) std::bind(&Application::x, this, std::placeholders::_1)
	...
	Application::Application()
	{
		...
		WindowProps props("CodePen-Studio Integrated Development Environment", settings.WindowWidth, settings.WindowHeight);
	...
	Application::~Application()
	{
		...
		PS_CORE_WARN("Shutting down CodePen Studio...");
	}
