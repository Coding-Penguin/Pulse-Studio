...
#	elif (GLM_ARCH & GLM_ARCH_MIFX_BIT) && (GLM_MODEL == GLM_MODEL_64)
#		pragma message("GLM: MIFX 64 bits build target")
#	elif (GLM_ARCH & GLM_ARCH_MIFX_BIT) && (GLM_MODEL == GLM_MODEL_32)
#		pragma message("GLM: MIFX 32 bits build target")
